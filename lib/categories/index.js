...
router.post('/', isAuthenticated, isAuthorized, upload.single('icon'), controller.store)
...
router.put('/:id', isAuthenticated, isAuthorized, upload.single('icon'), controller.update)
